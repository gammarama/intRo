...
In addition to making \texttt{intRo} intuitive to use, we've also created a documentation website that is consistent with the interface of the application and hyperlinked within the application itself. This documentation covers all default modules and makes learning to use \texttt{intRo} even more painless.
