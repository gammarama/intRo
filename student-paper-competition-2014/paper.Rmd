...
## Exciting
In general, introduction to statistics is a class undergraduate students dread. It's hard, the language is unfamiliar, and the software is difficult to use. With \texttt{intRo}, we hope to flip this paradigm. \texttt{intRo} is a fun, easy to use tool that's available on the web, and is also usable on mobile devices. As a web-based application, this tool is immediately more familiar to students than a desktop application. With interactive plots from \texttt{ggvis} [@ggvis], \texttt{intRo} brings a `wow'-factor to learning introductory statistics.
