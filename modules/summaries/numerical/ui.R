numerical_ui <- tabPanel("Numerical",
                                                  column(4,
                                                         wellPanel(
                                                             ...
                                                             tags$button("", id = "store_numerical", type = "button", class = "btn action-button", list(icon("save"), "Store Numerical Result"), onclick = "$('a:has(> .fa-print, .fa-code, .fa-download)').highlight();")
                                                         )
                                                  ),
