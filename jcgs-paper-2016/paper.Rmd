...
```{r, eval=FALSE}
download_intRo()
run_intRo(enabled_modules = c("data/transform", "summaries/numerical"), theme = "cerulean")
```
...
```{r, eval=FALSE}
deploy_intRo(enabled_modules = c("data/transform", "summaries/numerical"), theme = "cerulean")
```
...
## Modules
TODO: Rewrite this as the details behind the modularity. Add information on writing your own modules
