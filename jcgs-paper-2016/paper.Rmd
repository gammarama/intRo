...
software_compare <- rbind(software_compare,
                          ...
                          c("R Commander", "Yes", "Yes", "No", "No", "Yes", "Yes", "Yes", "Moderate"),
...
knitr::kable(software_compare, 
             caption="\\label{tab:compare}A comparison of statistical software packages across the metrics of usability, modularity, extensibility, and reproducibility. Partial fulfillment of requirements is noted in the table, as well as a measure of the complexity of functionality offered by default.", 
             col.names = c("Software", "GUI", "Install", "Modular", "Web-based", "Extensible", "Reproducible", "Functionality"))
```
